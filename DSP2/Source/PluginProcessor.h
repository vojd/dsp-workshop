...
//==============================================================================
class DspworkshopAdc2017AudioProcessor  : public AudioProcessor
{
public:
    //==============================================================================
    DspworkshopAdc2017AudioProcessor();
    ~DspworkshopAdc2017AudioProcessor();
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (DspworkshopAdc2017AudioProcessor)
};
